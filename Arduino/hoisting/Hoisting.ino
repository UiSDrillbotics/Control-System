...
void setup()
{
	...
	Serial.begin(57600); //experiment more with this. changing to 115200 drastically sped things up
...
void loop()
{
	...
	SumZLog[49] = sumZ_int; //originally 9
	sumZ_movingAvg += SumZLog[49];
	sumZ_int = sumZ_movingAvg / 49;
	...
	if (WOBControlenabled)
	{
		...
		WOBLog[49] = WOB_Measured_int; //originally 9
